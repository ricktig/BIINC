...
<head>
	...
	<title>BI Incorporated - DAPD Voucher System - Log In</title>
...
<body>
	...
	<?php include 'header.php';//display logo on logged in and not logged in page views?>
		...
		?>
			...
			<div style="width:250px;margin-top:10px;" class="center">
				<span>Click <a style="color:blue" href="passwordresetrequest.php">here</a> to reset your password.</span>
			</div>
