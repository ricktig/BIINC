...
<html>
    <head>
        ...
        <title>BI Incorporated - DAPD Voided Vouchers</title>
        <!--[if lt IE 9]>
	...
	<h2>View Voided Vouchers</h2>

	<form id="myform" name="myform" method="post" style="width:540px;line-height:2.6em" class="center" action="monthlyvoidscreen-do.php" data-parsley-validate novalidate>
...
?>
		...
		<h2 class="center" style="margin:20px 0 0 0">Only authorized users can access the monthly voided vouchers screen.</h2>
